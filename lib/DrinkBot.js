...
const mvcExplained = `Yes of course!

Ok here's the gist:

============== THE GIST ==============

*Model-View-Controller* is best thought of as ordering a drink from a bartender
...
Don't believe me? well here's the same thing but from a source more prone to error:
https://medium.freecodecamp.com/model-view-controller-mvc-explained-through-ordering-drinks-at-the-bar-efcba6255053`
